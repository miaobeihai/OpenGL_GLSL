...
public:
    ...
    void    render()
    {
        ...
        CELL::matrix4   tranView    =   mvp.transpose();
        CELL::tfrustum<float> frustum;
        frustum.loadFrustum(tranView);
        ...
        _shader.begin();
        {
            ...
            glVertexAttribPointer(_shader._uv,      4, GL_FLOAT, GL_FALSE, sizeof(Vertex), &grounds[0].u);
            glDrawArrays(GL_TRIANGLES, 0, 6);
        }       
        _shader.end();

        _modelMgr.render(_camera,frustum);
    }
