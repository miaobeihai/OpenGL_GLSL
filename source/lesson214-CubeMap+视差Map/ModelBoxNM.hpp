...
#include "Camera.hpp"
#include "ShaderNormalCubeMap.hpp"
class   ModelBoxNM
{
public:
    struct V3N3UV2
...
public:
    ...
    void    render(Camera& camera)
    {
        ...
        _program.begin();
        {
            ...
            model.rotateYXZ(angle,angle,angle);
            CELL::matrix4   invModel=   model.inverse();
            ...
            glUniformMatrix4fv(_program._invModel,  1, false, invModel.data());

            glUniform1i(_program._texture, 0);
            glUniform1i(_program._textureCube, 1);
