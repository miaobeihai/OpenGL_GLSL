...
//         }
    ...
    void    render(Camera& camera)
    {
        _program.begin();
        {
            ...
            glVertexAttribPointer(_program._binoraml,   3, GL_FLOAT, GL_FALSE, sizeof(ModelBoxNM::NORMALMAP), &_modelBox._data[0].bx);
